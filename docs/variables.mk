...
PROJECTS := k6-studio::$(notdir $(basename $(shell git rev-parse --show-toplevel))):docs/sources/k6-studio k6:UNVERSIONED:$(notdir $(basename $(shell git rev-parse --show-toplevel))):docs/sources/k6
