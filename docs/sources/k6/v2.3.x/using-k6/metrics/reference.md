...
| ------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| checks             | [Rate](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-metrics/rate/)    | The rate of successful checks. In the end-of-test summary, this metric is displayed as three values: `checks_total` (Counter), `checks_succeeded` (Rate), and `checks_failed` (Rate). These display values are not emitted to output backends and cannot be used in thresholds. |
