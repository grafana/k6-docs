...
| `K6_OTEL_HTTP_EXPORTER_USERNAME`   | Username for HTTP Basic authentication on the HTTP exporter.                                                                                                        |
| `K6_OTEL_HTTP_EXPORTER_PASSWORD`   | Password for HTTP Basic authentication on the HTTP exporter.                                                                                                        |
