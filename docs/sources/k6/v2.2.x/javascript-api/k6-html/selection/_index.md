...
| [Selection.single(selector)](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-html/selection/selection-single)                         | Returns at most one element matching the selector.                                                                                                     |
