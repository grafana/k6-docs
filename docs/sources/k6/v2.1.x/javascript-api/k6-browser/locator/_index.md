...
| [frameLocator(selector)](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-browser/locator/framelocator)                                                | Shorthand for `locator(selector).contentFrame()`. Returns a [FrameLocator](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-browser/framelocator/) for the iframe matching the given `selector`. |
...
| [isInViewport([options])](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-browser/locator/isinviewport)                                     | Checks if the element is in the viewport, with an optional visible-ratio threshold.                                    |
...
| [pressSequentially(text, [options])](https://grafana.com/docs/k6/<K6_VERSION>/javascript-api/k6-browser/locator/presssequentially)                     | Type text character by character, simulating real keyboard input.                                                       |
