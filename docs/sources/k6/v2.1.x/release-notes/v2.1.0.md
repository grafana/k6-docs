...
- An opt-in feature-flag system with the `--features` option, the `K6_FEATURES` environment variable, and a `k6 features` discovery command.
...
### Feature flags [#6055](https://github.com/grafana/k6/pull/6055), [#6056](https://github.com/grafana/k6/pull/6056)
