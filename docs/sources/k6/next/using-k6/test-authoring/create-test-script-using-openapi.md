...
Creating a k6 test script from scratch requires some JavaScript knowledge, as well as understanding k6 concepts such as the test lifecycle and k6 JavaScript APIs.
