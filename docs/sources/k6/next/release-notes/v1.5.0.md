...
menuTitle: v1.5.0
description: The release notes for Grafana k6 version 1.5.0
weight: 9984
---
...
For a full list of changes, including UX improvements and bug fixes, refer to the [full release notes](https://github.com/grafana/k6/blob/master/release%20notes/v1.5.0.md).
