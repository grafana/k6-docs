...
menuTitle: v2.0.0
description: The release notes for Grafana k6 version 2.0.0
weight: 9979
---
...
For a full list of changes, including UX improvements and bug fixes, refer to the [full release notes](https://github.com/grafana/k6/blob/master/release%20notes/v2.0.0.md).
