...
To run a cloud test from the CLI, authenticate with `k6 cloud login` — it will prompt you interactively for your API token and stack:

```bash
k6 cloud login
```

For non-interactive environments such as CI/CD, pass the values directly:
