...
Starting in k6 v1.8.0, the cloud secret source is enabled automatically when you run `k6 cloud run --local-execution`. You don't need to pass any flag, and `secrets.get()` works out of the box:
