...
[constant-arrival-rate](/using-k6/scenarios/executors/constant-arrival-rate) and [ramping-arrival-rate](/docs/k6/<K6_VERSION>/using-k6/scenarios/executors/ramping-arrival-rate):
