...
You can bypass SSL/TLS validation in trusted environments by checking the **Skip SSL/TLS certificate validation** option in k6 Studio settings. Use it carefully as it leaves connections open to man-in-the-middle (MITM) attacks.
