...
_Rate_ is an object for representing a custom metric keeping track of the percentage of added values that are non-zero. It is one of the four [custom metrics](/v0.31/javascript-api/k6-metrics).
...
| Method                                                                                 | Description                     |
| -------------------------------------------------------------------------------------- | ------------------------------- |
| [Rate.add(value, [tags])](/v0.31/javascript-api/k6-metrics/rate/rate-add-value-tags) ] | Add a value to the rate metric. |
