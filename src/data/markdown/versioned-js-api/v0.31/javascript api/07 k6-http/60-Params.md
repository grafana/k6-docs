...
| `Params.responseCallback` | [expectedStatuses](/v0.31/javascript-api/k6-http/expectedstatuses-statuses) | sets a [responseCallback](/v0.31/javascript-api/k6-http/setresponsecallback-callback) only for this request. For performance reasons it's better to initialize it once and reference it for each time the same callback will need to be used                                                                                                                                                                                                                                                                                                                                                      |
...
Here is another example using [http.batch()](/v0.31/javascript-api/k6-http/batch-requests) with a `Params` argument:
