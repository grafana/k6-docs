...
Returns a callback to be used with [setResponseCallback](/v0.31/javascript-api/k6-http/setresponsecallback-callback) to mark responses as expected based only on their status codes.
