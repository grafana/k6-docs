...
If you need the response body for some requests, override the option with [Params.responseType](/javascript-api/k6-http/params).
...
: To solve this, use the [URL grouping](/using-k6/http-requests/#url-grouping) feature.
