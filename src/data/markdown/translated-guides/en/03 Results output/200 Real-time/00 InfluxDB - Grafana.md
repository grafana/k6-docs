...
- Hover over any part of the panel to display the actions menu (three dots) on the top right corner. Click the menu and select **Edit** to set up the graph panel:
