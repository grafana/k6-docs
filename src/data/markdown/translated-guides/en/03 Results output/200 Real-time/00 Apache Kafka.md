---
title: 'Apache Kafka'
excerpt: 'k6 has a Kafka output extension. You can use it to send the metrics in real-time to Kafka. Apache Kafka is a stream-processing platform for handling real-time data.'
