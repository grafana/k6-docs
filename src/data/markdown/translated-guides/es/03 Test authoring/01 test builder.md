...
- Configurar las [zonas de carga](/cloud/creating-and-running-a-test/cloud-tests-from-the-cli/cloud-execution-reference/list-of-supported-load-zones) para ejecutarlo desde k6 Cloud.
