...
3. [Cloud](/cloud): la ejecución del test es en k6 Cloud.  
  ...
  Adicionalmente, k6 Cloud puede ejecutar cloud tests en tu [propia infraestructura cloud](/cloud/creating-and-running-a-test/private-load-zones/), y acepta los resultados de un test [local](/results-output/cloud/) o [distribuido en k8s](https://github.com/grafana/k6-operator#k6-cloud-output).
