...
We provide an [interactive demo environment in Killercoda](https://killercoda.com/grafana-xk6-disruptor/scenario/killercoda) which you can use to try xk6-disruptor right away without having to install Kubernetes on your loal machine.

You can use this sandbox to try out xk6-disruptor and start injecting faults and writing tests on a microservice-based application right away.
