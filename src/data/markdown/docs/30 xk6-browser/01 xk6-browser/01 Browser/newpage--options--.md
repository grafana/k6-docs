...
| <nobr><span title="Not implemented">❌</span> storageSpace</nobr>                | object  | Saves the given data in the default browser context. See [storageSpace options](#storagespace-options) for more details.                                                                                                                                                                                                                                                                 |
