...
| [clear(url)](/javascript-api/k6-http/cookiejar/cookiejar-clear) | Clear all cookies in the jar by specifying url. |
| [delete(url, name)](/javascript-api/k6-http/cookiejar/cookiejar-delete) | Delete a cookie in the jar by specifying url and name. |
