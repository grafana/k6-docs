...
Creates and returns a new [BrowserContext](/javascript-api/k6-browser/api/browsercontext/).
...
| Type   | Description                                                          |
| ------ | -------------------------------------------------------------------- |
| object | [BrowserContext](/javascript-api/k6-browser/api/browsercontext/) object |
