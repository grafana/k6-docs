...
1 - Open up your firewall to the whole range of AWS IP addresses used by the load zones where you want to run your load test from. We list [here](/cloud/cloud-faq/general-questions/#how-to-open-a-firewall-to-k6-cloud-service-for-cloud-tests) the full range of IP addresses.
