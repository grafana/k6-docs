...
> 
> Any user can copy the script from the k6 Cloud web editor to edit and run localy the k6 test. 
> 
> _This integration has allowed us to benefit from the capabilities of the k6 Cloud web app. In the future, we plan to make the extensions operational without the k6 Cloud_.
...
> #### Things to consider
>
> - The autogenerated script sets [discardResponseBodies](/using-k6/options#discard-response-bodies) to `true`. This will discard all response bodies by default.
